...
def plot_ps_modified_kernel():
    ...
    for plot_ind, plot_version in enumerate(plot_ps_versions):
        for file_ind, spacing in enumerate(uv_spacings):
            data_path = f"{cal_error_path}/ps/data/1d_binning/sim_uv_spacing_{spacing}_short_bls_cal_error__{plot_version}.idlsave"
...
def plot_ps_modified_kernel_cal_amp_error_only():
    ...
    plot_names = [
        "ps_cal_amp_error_modified_kernel_no_horizon_wedge.png",
        "ps_cal_amp_error_modified_kernel_no_fov_wedge.png",
        "ps_cal_amp_error_modified_kernel_no_wedge_cut.png",
    ]
    ...
    for plot_ind, plot_version in enumerate(plot_ps_versions):
        for file_ind, spacing in enumerate(uv_spacings):
            data_path = f"{cal_error_path}/ps/data/1d_binning/sim_uv_spacing_{spacing}_short_bls_cal_amp_error__{plot_version}.idlsave"
