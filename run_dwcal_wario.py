...
def gain_ripple_lambda_1_May18():

    save_dir = "/safepool/rbyrne/calibration_outputs/gain_ripple_lambda_1_May18"
    ripple_gains_cal_savefile = "/safepool/rbyrne/calibration_outputs/gain_ripple_test_May6/ripple_initial_gains.calfits"
...
def newtons_test_Jun6():

    save_dir = "/safepool/rbyrne/calibration_outputs/caltest_Jun6"
    gain_init_calfile = (
        "/safepool/rbyrne/calibration_outputs/caltest_Jun6/unity_gains_dwcal.calfits"
    )
...
def unity_gains_test_Jun17():
    ...
    #    use_autos=False,
    #    weight_mat_option="diagonal",
    #    cal_savefile="/safepool/rbyrne/calibration_outputs/caltest_Jun17/unity_gains_diagonal.calfits",
    #    log_file_path="/safepool/rbyrne/calibration_outputs/caltest_Jun17/unity_gains_diagonal_log.txt",
    # )
    ...
    dwcal.calibrate(
        ...
        cal_savefile="/safepool/rbyrne/calibration_outputs/caltest_Jun17/unity_gains_dwcal.calfits",
        log_file_path="/safepool/rbyrne/calibration_outputs/caltest_Jun17/unity_gains_dwcal_log.txt",
    )


def random_gains_test_Jun29():

    save_dir = "/safepool/rbyrne/calibration_outputs/caltest_Jun17"
...
def random_gains_test_Jul25():

    save_dir = "/safepool/rbyrne/calibration_outputs/caltest_Jul25"
...
def multiple_times_tests_Nov7():
    ...
    for use_Ntimes in [2, 4]:
        ...
        log_file_path = f"{save_dir}/random_gains_diagonal_ntimes{use_Ntimes}_log.txt"
