...
def convert_smoothed_cal_to_uvfits_Aug3():

    for width in [5, 7, 9, 21]:
        filename = f"/lustre/rbyrne/2026-04-19/20260419_055641-055832_44MHz_17h_smoothed_bh{width}_peeled.ms"
        uv = pyuvdata.UVData()
        uv.read(filename)
        uv.write_uvfits(
            f"/lustre/rbyrne/2026-04-19/20260419_055641-055832_44MHz_17h_smoothed_bh{width}_peeled.uvfits",
            uvw_double=False,
        )


def apply_selfcal_Aug3():

    calibration_pipeline(
        f"/lustre/pipeline/cosmology/concatenated_data/44MHz/2026-04-19/05/20260419_055641-055832_44MHz.ms",
        output_dir="/lustre/rbyrne/2026-04-19",
        tmp_dir="/fast/rbyrne",
        cal_trial_name=f"wsclean_selfcal",
        run_aoflagger=True,
        flag_antennas_from_autocorrs=False,
        flag_antenna_list=[
            "LWA-266B",
...
def selfcal_with_wsclean_and_gain_initialization_Aug3():
    ...
    uvcal = calibration_wrappers.sky_based_calibration_wrapper(
        data,
        model,
        gain_init_calfile="/fast/rbyrne/calibration_2026-04-19_17h_44MHz_flagged.calfits",
        min_cal_baseline_lambda=10,
        max_cal_baseline_lambda=125,
        gains_multiply_model=True,
        verbose=True,
    ...
    uvcal.write_calfits(
        f"/fast/rbyrne/20260419_055641-055832_44MHz_wsclean_selfcal_with_initialization.calfits",
        clobber=True,
    )
