...
for use_subband in subbands:
    reference_file = f"/lustre/rbyrne/2024-03-03/referece_data_for_sims/2024-03-03/20240303_093000_{use_subband}MHz.ms"
    time_string = print(str(93000 + 10 * time_offset).zfill(6))
